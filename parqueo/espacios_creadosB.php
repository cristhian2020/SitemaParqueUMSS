...
<body class="hold-transition sidebar-mini">
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            <div class="container">
                <h2 class="text-center mb-4">Listado de sitios creados en la sección “B”</h2>
                <br>
                <form action="delete_espacio.php" method="post">
                    <div class="transLeft container">
                        <div class="row">
                            <div class="col-md-12">
                                <a href="espacios_creados.php" class="btn btn-primary">Sección "A"</a>
                            </div>
                        </div>
                    </div>
                    <br>
                        ...
                        <div class="col-md-6">
                            <table class="table table-bordered  table-sm">
                                ...
                                <tbody>
                                    <?php
                                   $contador = 0;
                                   $query_mapeos = $pdo->prepare("SELECT id_map, espacio, estado_espacio FROM tb_mapeos WHERE seccion = 'B' AND estado = '1'");
                                   ...
                                   foreach ($mapeos as $mapeo) {
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td>
                                                <center><input type="checkbox" name="delete[]" value="<?php echo $id_map; ?>" <?php echo $checkbox_disabled; ?>></center>
                                            </td>
                                            <td>
                    ...
                    <button type="submit" class="btn btn-danger" name="submit">Borrar seleccionados</button>
                </form>
            </div>
            <br>
