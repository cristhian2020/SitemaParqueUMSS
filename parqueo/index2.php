    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            <div class="container">
                ...
                <h1 style="color:black;">Espacios parqueo "B"</h1>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="d-flex justify-content-center">
                            ...
                            <a href="" class="btn btn-dark" style="background-color: #9fa3a9;">
                    ...
                    <div class="col-md-6">
                        ...
                        <h5 class="info-anuncio float-sm-start">
                            ...
                            ¡Descubre nuestros espacios disponibles en la sección "B" del estacionamiento!<br>
                        ...
                        <img src="../public/imagenes/IMG20230609085940.jpg" class="img-fluid" alt="">
                        <br>
                        <br>
                    </div>
                    <br>
