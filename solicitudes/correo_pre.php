    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            <div class="container">
                ...
                <form action="correo_bienvenido.php" method="post">
                    <div class="form-group">
                        <label for="to">Destinatario:</label>
                        <textarea class="form-control" id="to" name="to" rows="3" required></textarea>
                        <p class="form-text text-muted">Si usted desea mandar a más de una persona el mismo mensaje, ingrese los correos electrónicos separados por comas. (Ejemplo: user1@gmail.com, user2@gmail.com, user3@gmail.com, user4@gmail.com)</p>
                    </div>
                    <button type="submit" class="btn btn-primary">Bienvenido</button>
                </form>
                <br>
                <form action="correo_deuda.php" method="post">
                    <div class="form-group">
                        <label for="to">Destinatario:</label>
                        <textarea class="form-control" id="to" name="to" rows="3" required></textarea>
                        <p class="form-text text-muted">Si usted desea mandar a más de una persona el mismo mensaje, ingrese los correos electrónicos separados por comas. (Ejemplo: user1@gmail.com, user2@gmail.com, user3@gmail.com, user4@gmail.com)</p>
                ...
                <br>
                <form action="correo_no_disponible.php" method="post">
                    <div class="form-group">
                        <label for="to">Destinatario:</label>
                        <textarea class="form-control" id="to" name="to" rows="3" required></textarea>
                        <p class="form-text text-muted">Si usted desea mandar a más de una persona el mismo mensaje, ingrese los correos electrónicos separados por comas. (Ejemplo: user1@gmail.com, user2@gmail.com, user3@gmail.com, user4@gmail.com)</p>
