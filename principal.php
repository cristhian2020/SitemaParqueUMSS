    ...
    <div class="content-wrapper">
      ...
      <div class="container ">
        <center>
          ...
          <h3>Sección "A"</h3>
          <p>¡Bienvenido al Parqueo A!

            Nos complace recibirte en nuestro moderno y seguro parqueo. Aquí encontrarás un espacio diseñado para brindarte comodidad y tranquilidad mientras estacionas tu vehículo</p>
        </center>
        <br>
        <center>

          <img src="./public/imagenes/IMG20230609090354.jpg" width="250px" height="100px" alt="" class="img-fluid">
        </center>
        <br>
        ...
        <div class="d-flex justify-content-between">
          ...
          <a href="principal2.php" class="btn btn-dark">Sección "B"</a>
        </div>
        <br>
        <br>

        <!-- 
                  <img src="public/imagenes/Decanato_fcyt.jpg" class="img-fluid" alt="Responsive image">
                            ...
                            <div class="modal-dialog">
                              <div class="modal-content">
                                <div class="modal-header">
                                  <h5 class="modal-title" id="exampleModalLabel">Estado del sitio "A": <?php echo "<span style='font-size: 25px;'>" . $espacio . "</span>" ?></h5>
